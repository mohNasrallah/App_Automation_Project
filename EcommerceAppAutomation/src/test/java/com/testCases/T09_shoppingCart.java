...
import com.pages.P08_shoppingCartPage;
...
public class T09_shoppingCart {
    ...
    public void user_press_on_shopping_cart_in_header() throws InterruptedException {
        T013_Hooks.driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
    ...
    public void webpage_redirect_to_shopping_cart() {
        String actualRedirectedURL = T013_Hooks.driver.getCurrentUrl();
